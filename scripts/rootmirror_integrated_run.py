...
def main() -> int:
    ...
    integrated = integrate_rootmirror_lite_score(run_result, rm_result)
    ...
    inject_integrated_result_into_state(artifacts.get("state", ""), integrated)
    inject_integrated_result_into_evidence(artifacts.get("evidence", ""), integrated)
